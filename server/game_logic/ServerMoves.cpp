...
// ---------------------------------------------------------------------------
ServerMoves::ServerMoves(const std::string& txt_path, std::pair<int,int> board_dims)
...
// ---------------------------------------------------------------------------
ServerMoves::RelMove ServerMoves::parse_line(const std::string& s) {
    auto pos = s.find(':');
...
// ---------------------------------------------------------------------------
bool ServerMoves::is_dst_cell_valid(int dr, int dc, bool dst_has_piece) const {
...
bool ServerMoves::is_valid(const std::pair<int,int>& src_cell,
...
bool ServerMoves::path_is_clear(const std::pair<int,int>& src_cell,
                          const std::pair<int,int>& dst_cell,
                          const std::unordered_set<std::pair<int,int>, PairHash>& cell_with_piece) const {
    int dr = dst_cell.first - src_cell.first;
    int dc = dst_cell.second - src_cell.second;
